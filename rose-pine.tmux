...
main() {
    ...
    local show_session
    readonly show_session="#[fg=$thm_text][#S]"

    local show_directory
    readonly show_directory="$left_separator#[fg=$thm_subtle]#[fg=$thm_rose]#{b:pane_current_path}$right_separator"

    local show_user
    readonly show_user="#[fg=$thm_iris]#(whoami)#[fg=$thm_subtle]$right_separator"

    local show_host
    readonly show_host="#[fg=$thm_text]#H#[fg=$thm_subtle]$right_separator#[fg=$thm_subtle]$hostname_icon"

    local show_date_time
    readonly show_date_time="#[fg=$thm_foam]$date_time#[fg=$thm_subtle]"
